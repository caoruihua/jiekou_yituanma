...
report_path = os.path.dirname(os.path.abspath('.')) + '/jiekou_yituanma/report/'
...
# 导入用例
def case_all():
    case_pash = os.path.dirname(os.path.abspath('.')) + '/jiekou_yituanma/testcase'
...
if __name__ == '__main__':
    ...
    runner = HTMLTestRunner_cn.HTMLTestRunner(stream=fp,
                                              title=title + '：', verbosity=2,retry=0)
